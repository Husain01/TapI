          ...
          <div className="options__header-options">
            <div className="options__header-option">
              ...
              <div className="options__content">
                <h2>For Students</h2>
                <p>
                  Everyone knows you’re a student, but your card will help
                  people remember what you studied.
                </p>
              </div>
            </div>
            <div className="options__header-option">
              ...
              <div className="options__content">
                ...
                <p>
                  First impression should be your best impression for your
                  upcoming project!
                </p>
              </div>
            </div>
